...
namespace DXApplication2.Web
{
    public class Globe
    {
        ...
        public const string WhoScoredFixturesUrl = "http://www.whoscored.com/Teams/";
        ...
        public static string FixtureRootDir = string.Empty;
        public const string CONFIG_FIXTURE_ROOT_DIR = "FixtureRootDir";


        public static string TeamRootDir;
        ...
        public static Dictionary<string, string> FixturesDic = new Dictionary<string, string>();
        public const string CONFIG_FIXTURES = "Fixtures";



        private static readonly string LogFile = System.AppDomain.CurrentDomain.BaseDirectory + @"log.txt";
        //Log dosyasının dosya yolunu gösterir.
        ...
        public static void WriteLog(string txt)
        {
            try
            {
                ...
                //Log dosyasını bularak, üstüne yazıyor.
                sw.WriteLine(DateTime.Now.ToString("yyyy/MM/dd HH:mm:ss") + " - " + txt);
                //Şimdiki zamana "Servis Başlıyor…" ekleyerek log dosyasına yazıyor
                sw.Flush();
                sw.Close();
            }
            catch (Exception)
        ...
        public static string LoadFile(string fileName)
        {
            ...
            {
                Globe.WriteLog("Okunamayan dosya : " + fileName + ex.Message);
            }
    ...
    {
        public int id;
        public float homeTeamHalfTimeGoals;
        public float awayTeamHalfTimeGoals;
        ...
        public int Homeid;
        public int awayid;
        public bool ms1, ms2, ms0, iy1, iy2, iy0, cs10, cs02, cs12, iycs10, iycs02, iycs12, ms15ust, ms25ust, ms35ust, iy15ust, iy25ust, iy05ust, ms15alt, ms25alt, ms35alt, iy15alt, iy25alt, iy05alt;
        public string skor, IYSkor;
    ...
    public class TeamStatistics
    {
        ...
        public float first_half_goals;
        public float fk_foul_lost;
        public float fk_foul_won;
        public float formation_used;
        public float forward_goals;
        ...
        public float goals;
        public float goals_conceded;
        public float goals_conceded_ibox;
        public float goals_conceded_obox;
        ...
        public float possession_percentage;
    ...
    public class PlayerStatistics
    {
        ...
        //public string rating_defensive;
        //public string rating_defensive_points;
        //public string rating_offensive;
        //public string rating_offensive_points;
